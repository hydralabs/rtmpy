...
***********************
Reporting Bugs in RTMPy
***********************

Bug reports should be submitted via the RTMPy Bug Tracker on http://dev.rtmpy.org.
...
the RTMPy Bug Tracker.  If you don't already have a tracker account, select the
`Register <http://dev.rtmpy.org/register>`_ link in the navigation bar and
...
`New Ticket <http://dev.rtmpy.org/newticket>`_ link in the sidebar to open the
bug reporting form.
